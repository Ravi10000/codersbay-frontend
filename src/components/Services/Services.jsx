...
//         <div className="ServiceCard EComm">
//           <p className="cardText">E-Commerce</p>
//         </div>
//         <div className="ServiceCard Professional">
//           <p className="cardText">Professional Service</p>
//         </div>
//         <div className="ServiceCard ERP">
//           <p className="cardText">ERP and CRM</p>
//         </div>
//         <div className="ServiceCard Cloud">
//           <p className="cardText">Cloud Engineering</p>
//         </div>
//         <div className="ServiceCard IT">
